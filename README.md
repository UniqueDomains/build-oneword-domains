# Available .BUILD One-Word Domains (9,221)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C221%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-9%2C221%20domains-6f42c1">
...
**Public extract:** 9,221 rows · **Live catalog:** 9,221 domains
...
- `build.csv` — public CSV extract (9,221 rows)
- `build.json` — public JSON extract (9,221 rows)
...
| space.build      | resell    | —         | —             | 80             | 60     | 5      | Spaceship, Inc. |
...
| goon.build       | available | $39.98    | —             | 80             | 36     | 5      | namecheap       |
...
| ----------------------- | ------------------------------------------------ |
| 9,221-row public sample | 9,221 live domains                               |
...
> Unique Domains. *Available .BUILD One-Word Domains*. Version 2026-04-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
